...
public class NNBLBrew {
	...
	public String toString() {
		...
		String s = brewName + " by " + brewer + System.lineSeparator();
		s += "Grain weight: " + grainweight + "g" + System.lineSeparator();
		s += "Efficiency: " + efficiency + "%" + System.lineSeparator();
		s += "OG: " + originalGravity + System.lineSeparator();
		s += "FG" + finalGravity + System.lineSeparator();
		s += "Mash temp: " + mashTemp + "C" + System.lineSeparator();
		s += "Attanuation: " + attenuation + System.lineSeparator();
		s += "Yeast type: " + yeastType + System.lineSeparator();
		s += "Remarks: " + remarks + System.lineSeparator();
		s += "Color in gui" + color + System.lineSeparator();
