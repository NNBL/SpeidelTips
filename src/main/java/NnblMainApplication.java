...
public class NnblMainApplication extends Application implements Initializable, ChangeListener {
  ...
  private void initDropdown() {
    dropdown.setItems(FXCollections
        .observableArrayList("Efficiency vs grain weight", "Mash temp vs yeast attenuation"));
  ...
  private void initTable() {
    ...
    brewName.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, String>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, String> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    brewer.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, String>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, String> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    grainWeight.setCellFactory(
      TextFieldTableCell.<NNBLBrew, Integer>forTableColumn(new IntegerStringConverter()));
    grainWeight.prefWidthProperty().bind(table.widthProperty().multiply(0.1));
    grainWeight.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Integer>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Integer> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    efficiency.setCellFactory(
      TextFieldTableCell.<NNBLBrew, Double>forTableColumn(new DoubleStringConverter()));
    efficiency.prefWidthProperty().bind(table.widthProperty().multiply(0.1));
    efficiency.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Double>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Double> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    og.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Integer>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Integer> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    fg.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Integer>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Integer> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    mashTemp.setCellFactory(
      TextFieldTableCell.<NNBLBrew, Double>forTableColumn(new DoubleStringConverter()));
    mashTemp.prefWidthProperty().bind(table.widthProperty().multiply(0.1));
    mashTemp.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Double>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Double> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    attenuation.setCellFactory(
      TextFieldTableCell.<NNBLBrew, Double>forTableColumn(new DoubleStringConverter()));
    attenuation.prefWidthProperty().bind(table.widthProperty().multiply(0.1));
    attenuation.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, Double>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, Double> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    yeastType.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, String>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, String> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    remarks.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<NNBLBrew, String>>() {
        @Override public void handle(TableColumn.CellEditEvent<NNBLBrew, String> t) {
          ((NNBLBrew) t.getTableView().getItems().get(t.getTablePosition().getRow()))
    ...
    table.getColumns()
      .addAll(brewName, brewer, grainWeight, efficiency, og, fg, mashTemp, attenuation, yeastType,
        remarks);
  ...
  @FXML protected void exitApplication() {
    System.exit(0);
  }
