...
weightdata = np.genfromtxt("weight_vs_efficiency.csv", \
...
pl.plot(weightdata["Grainweight_g"], weightdata["Efficiency_"], \
        "ro", weightdata["Grainweight_g"], \
        wfit_fn(weightdata["Grainweight_g"]), "--g")
...
pl.plot(attdata["Mash_temperature_C"], attdata["Attenuation_"], \
        "bo", attdata["Mash_temperature_C"], \
        afit_fn(attdata["Mash_temperature_C"]), "--g")
